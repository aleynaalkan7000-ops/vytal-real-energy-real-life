...
export const t = {
  en: {
    ...
    hero: {
      ...
      priceHint: "From €68 · ~€2.60 per drink · deposit refunded on return",
    },
    home: {
      ...
      overstimBodyA: "Modern productivity asks us to perform at 110% and call the burnout a personality trait. Energy drinks are designed for that script — fast spike, faster crash, more sugar, more cans, more guilt.",
      overstimBodyB: "VYTAL was made because we stopped believing in that loop.",
    ...
    about: {
      ...
      humanBodyA: "We're a small team based in Munich. No growth-at-all-costs deck. No twenty-person marketing floor. Just a quiet studio, a long table, and a stubborn belief that brands made calmly tend to age better.",
    ...
    contact: {
      ...
      closingDesc: "Whenever you're ready — we're here, quietly, in Munich.",
    ...
    starterKit: {
      ...
      h1a: "Begin the",
      h1b: "refill ritual.",
      priceNote: "€68 · giftable · deposit included",
      ...
      finalAddCta: "Add Starter Kit — €68",
  ...
  de: {
    ...
    hero: {
      ...
      priceHint: "Ab €68 · ~2,60€ pro Drink · Pfand wird bei Rückgabe erstattet",
    },
    home: {
      ...
      overstimBodyA: "Die moderne Produktivitätskultur verlangt 110 % – und nennt den Burnout Persönlichkeit. Energy Drinks sind für dieses Script gemacht: schneller Spike, schnellerer Crash, mehr Zucker, mehr Dosen, mehr Schuldgefühle.",
      overstimBodyB: "VYTAL entstand, weil wir aufgehört haben, an diesen Kreislauf zu glauben.",
    ...
    about: {
      ...
      humanBodyA: "Wir sind ein kleines Team in München. Kein Wachstum-um-jeden-Preis-Deck. Kein zwanzigköpfiger Marketing-Floor. Nur ein ruhiges Studio, ein langer Tisch und die hartnäckige Überzeugung, dass ruhig gemachte Marken besser altern.",
    ...
    contact: {
      ...
      pillars: [
        { k: "01", t: "Echte Menschen", d: "Geschrieben von einem kleinen Team in München. Kein ausgelagerter Support, keine Scripts." },
      ...
      closingDesc: "Wann immer du bereit bist – wir sind still da, in München.",
    ...
    starterKit: {
      ...
      h1a: "Beginne das",
      h1b: "Nachfüll-Ritual.",
      priceNote: "€68 · als Geschenk geeignet · Pfand inklusive",
      ...
      finalAddCta: "Starter Kit hinzufügen — €68",
