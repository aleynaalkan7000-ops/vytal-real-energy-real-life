...
const aluCylinderBreadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Shop", item: "https://vytal-energy.de/shop" },
    {
      ...
      position: 3,
      name: "The Cylinder",
      item: "https://vytal-energy.de/shop/alu-cylinder",
    },
  ],
};
  ...
  head: () => ({
    meta: [
      { title: "The cylinder — VYTAL refill system." },
      {
        name: "description",
        content:
          "The reusable matte aluminum cylinder that every VYTAL refill arrives inside. Included in the kit, returned for deposit, sterilized and refilled. Part of the circular loop.",
      },
      { property: "og:title", content: "The cylinder — VYTAL refill system." },
      {
        property: "og:description",
        content:
          "Not a product. The vessel. Included with every refill. Returned for deposit. Refilled, refined, re-released.",
      },
    ...
    <main className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-10 pb-16 md:pb-24 pt-32 grid md:grid-cols-12 gap-8">
          <div className="md:col-span-8">
            ...
            <p className="mt-8 max-w-lg text-lg text-foreground/75 leading-relaxed reveal">
              The matte aluminum cylinder isn't sold separately — it's the vessel every refill
              arrives inside. Included in the kit. Returned for deposit. Sterilized and refilled.
              Part of the loop.
            </p>
          </div>
      ...
      <section className="sticky top-16 z-30 bg-background/90 backdrop-blur-xl border-y border-border">
        <div className="max-w-7xl mx-auto px-6 md:px-10 py-5 flex flex-wrap items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <Link
              to="/shop"
              className="hidden md:inline-flex border border-foreground/15 px-5 py-3 rounded-full text-sm font-medium hover:bg-secondary transition-colors"
            >
              Browse refills
            </Link>
          </div>
      ...
      <section className="px-6 md:px-10 max-w-7xl mx-auto pb-32 md:pb-44 grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
        <div className="lg:col-span-6 order-2 lg:order-1 reveal">
          ...
          <p className="mt-8 text-muted-foreground leading-relaxed max-w-md">
            Hold the cylinder over the opening of your VYTAL bottle. Press once. A single tablet
            drops in — hygienically, never touched, never crumbled.
          </p>
          <ol className="mt-10 space-y-5 max-w-md">
            {[
              ...
              <li key={t} className="flex gap-5 items-start border-t border-border pt-5">
                <span className="font-mono text-xs text-primary tracking-[0.2em] mt-1">
                  0{i + 1}
                </span>
                <div>
          ...
          >
            <span
              className={`size-2 rounded-full bg-primary transition-transform duration-500 ${pressed ? "scale-150" : ""}`}
            />
          ...
          <div className="relative aspect-[4/5] overflow-hidden rounded-md bg-[#f1ece1]">
            ...
            <div
              className={`absolute inset-0 transition-all duration-700 ${
                pressed ? "bg-primary/10 backdrop-brightness-105" : "bg-transparent"
              }`}
            />
          </div>
        </div>
      ...
      <section className="relative bg-foreground text-background overflow-hidden">
        <div className="grid lg:grid-cols-2">
          <div className="relative aspect-[16/12] lg:aspect-auto lg:min-h-[680px] overflow-hidden">
            <img
              src={aluMacro}
              alt="Makrodetail der gebürsteten Aluminiumoberfläche und des runden Druckknopfes"
              loading="lazy"
              className="absolute inset-0 w-full h-full object-cover"
            />
          </div>
          <div className="px-6 md:px-12 lg:px-16 py-24 md:py-32 lg:py-44 flex flex-col justify-center">
            <span className="font-mono text-[11px] uppercase tracking-[0.32em] text-accent reveal">
              02 · Material
            </span>
            <h2 className="reveal mt-5 font-display text-4xl md:text-6xl font-bold leading-[0.98] tracking-tight">
              Hygienic by
              <br />
              <span className="italic font-light text-background/70">design.</span>
            </h2>
            <p className="reveal mt-8 text-background/70 leading-relaxed max-w-md">
              The shell is air- and moisture-tight. No fingerprints on tablets, no crumbling, no
              humidity creeping in. Aluminum, because it's light, it's recyclable, and it lasts.
            </p>
            ...
            <dl className="reveal mt-14 grid grid-cols-2 gap-x-8 gap-y-8 max-w-md">
              {[
                ...
                <div key={k}>
                  <dt className="font-mono text-[10px] uppercase tracking-[0.22em] text-background/45">
                    {k}
                  </dt>
      ...
      <section className="relative px-6 md:px-10 py-32 md:py-44 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5 reveal lg:sticky lg:top-28">
            ...
            <p className="mt-8 text-muted-foreground leading-relaxed max-w-md">
              When you've collected five empty cylinders, drop them unfranked into any postbox. They
              return to us, get sterilized, refilled and re-released into the loop. Deposit credited
              the moment they reach us.
            </p>
            <p className="mt-6 text-sm text-muted-foreground/80 max-w-md">
              Roughly 85% less shipping volume vs. canned drinks. Roughly zero plastic wrappers.
              Honest numbers — published every quarter.
            </p>
          </div>
          ...
          <div className="lg:col-span-7">
            <div className="relative aspect-[16/10] overflow-hidden rounded-md mb-6 reveal">
              <img
                src={aluLoop}
                alt="Fünf leere matte Aluminiumzylinder in einer Reihe"
                loading="lazy"
                className="absolute inset-0 w-full h-full object-cover"
              />
            </div>
              ...
              {[
                {
                  n: "01",
                  t: "Carry & use",
                  d: "Use the cylinder daily. Refill your bottle anywhere.",
                },
                {
                  n: "02",
                  t: "Collect five",
                  d: "When five are empty, slip them into the return pouch.",
                },
                {
                  n: "03",
                  t: "Send back",
                  d: "Drop into any postbox. Pre-paid, unfranked. No app.",
                },
                {
                  n: "04",
                  t: "Re-released",
                  d: "We sterilize, inspect, refill. Back into the system.",
                },
              ].map((s) => (
                <li
                  key={s.n}
                  className="reveal rounded-2xl border border-border bg-secondary/40 p-6 hover:bg-secondary transition-colors duration-500"
                >
      ...
      <section className="relative overflow-hidden">
        <div className="relative h-[80svh] min-h-[560px] w-full">
          <img
            src={aluDesk}
            alt="Ruhiger Schreibtisch mit Notizbuch, Keramiktasse, Aluminiumzylinder und kleiner salbeigrüner Flasche im warmen Morgenlicht"
            loading="lazy"
            className="absolute inset-0 w-full h-full object-cover"
          />
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="max-w-7xl mx-auto w-full px-6 md:px-10 pb-16 md:pb-24">
            ...
            <p className="reveal mt-6 max-w-md text-background/85 leading-relaxed">
              Quiet enough to live next to your notebook. Considered enough to feel like the things
              you'd bring on the move.
            </p>
          </div>
        </div>
      </section>
