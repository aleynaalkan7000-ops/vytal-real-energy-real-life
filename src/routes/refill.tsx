...
heroCta2: isDE ? "Ritual aufbauen" : "Build your ritual",
    ...
    ritualQuote: isDE ? "Dieselbe Flasche. Tag für Tag. Eine stille Veränderung, die tatsächlich Bestand hat" : "The same bottle. Day after day. A quiet change that actually lasts.",
