...
import { PackageOpen, FlaskConical, Recycle, Leaf, RotateCcw, Droplets } from "lucide-react";
...
const refillFaqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "How does the VYTAL refill system work?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Fill your VYTAL bottle with cold water, drop in one tablet, wait about 90 seconds for it to dissolve, and drink. Order refill cylinders online — each cylinder holds 8 tablets and includes a €4 refundable deposit.",
      },
    },
    {
      "@type": "Question",
      name: "Why use tablets instead of a ready-made drink?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Most ready-to-drink energy products are mostly water — shipping liquid in single-use cans. VYTAL only ships the functional concentrate. You add local water, reducing shipping volume by up to 85% and eliminating single-use packaging per drink.",
      },
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      name: "What water works best with VYTAL tablets?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Cold still water dissolves the tablet most cleanly. Sparkling water works too and gives a slightly lighter result. Avoid hot water as it can degrade some active ingredients.",
      },
    },
  ],
};
...
function useRefillTx() {
  ...
  return {
    ...
    ch02SingleText: isDE
      ? "Die meisten Fertiggetränke bestehen großteils aus Wasser – einmal gekauft, einmal getrunken, weggeworfen."
    ...
    ch02OverText: isDE
      ? "Klassische Energy-Kultur verkauft Intensität: hoher Zucker, lautes Branding, schneller Konsum und ein eingebauter Crash."
    ...
    ch02AltText: isDE
      ? "VYTAL ändert das Format: eine wiederverwendbare Flasche, kompakte Nachfüllungen und eine ruhigere Art, Energie in den Alltag zu integrieren."
      ...
      ? [
          {
            n: "01",
            t: "Öffnen",
            d: "Ein langsames Aufschrauben. Eine Pause, bevor der Tag beginnt.",
          },
          {
            n: "02",
            t: "Einwerfen",
            d: "Eine kompakte Tablette trifft auf stilles, klares Wasser.",
          },
          {
            n: "03",
            t: "Auflösen",
            d: "Blasen steigen auf. Die Farbe weicht. Die Flasche atmet aus.",
          },
          {
            n: "04",
            t: "Trinken",
            d: "Ruhiger Fokus, mit dir unterwegs. Keine Dose. Kein Abfall.",
          },
        ]
      : [
    ...
    ritualQuote: isDE
      ? "Dieselbe Flasche. Tag für Tag. Eine stille Veränderung, die tatsächlich Bestand hat"
      : "The same bottle. Day after day. A quiet change that actually lasts.",
    ...
    heroDesc: isDE
      ? "Eine nachfüllbasierte Alternative zu Einweg-Energy-Drinks – konzentrierte Tabletten, eine wiederverwendbare Flasche und ein Rückgabe-Loop, der von Anfang an weniger verschwendet."
      : "A refill-based alternative to disposable energy drinks — concentrated tablets, a reusable bottle, and a return loop designed to waste less from the start.",
    ...
    ch04Desc: isDE
      ? "Wir haben das System rund um Nachfüllstationen gebaut: Befülle deinen Heimcontainer mit Tabletten oder lass dir direkt ein trinkfertiges Getränk in die Flasche geben. Für Tage ohne Station: Online-Nachfüllungen kommen in wiederverwendbaren Pfandzylinder."
      : "We built the system around refill stations first: fill your home container with tablets, or get one tablet and water directly into your bottle for a ready-to-go drink. For days without station access, online refills arrive in reusable deposit cylinders.",
    ch04Steps: isDE
      ? [
          {
            n: "01",
            title: "Zuhause vorrätig",
            text: "Befülle deinen Heimcontainer mit Tabletten an der Station. Sicher lagern, bei Bedarf verwenden.",
            icon: "station",
          },
          {
            n: "02",
            title: "Unterwegs trinken",
            text: "Stelle deine Flasche in die Station. Wähle einen Geschmack und geh mit einem fertigen Drink.",
            icon: "bottle",
          },
          {
            n: "03",
            title: "Online bestellen",
            text: "Wenn keine Station in der Nähe ist, bestelle Nachfüllzylinder online. Leere zurückschicken, damit wir sie reinigen und wiederverwenden können.",
            icon: "loop",
          },
        ]
      : [
    ...
    ch05Specs: isDE
      ? [
          [
            "Format",
            "108 mm · 38 g. Fasst genau 8 funktionale Tabletten. Für Taschen, Rucksäcke oder Schreibtische.",
          ],
          ["Material", "Luftfahrt-Aluminium, eloxiert für eine matte, haptische Oberfläche."],
          [
            "Dichtung",
            "Luft- und feuchtigkeitsdichte Silikon-Dichtung. Tabletten bleiben sauber, trocken und unberührt.",
          ],
          [
            "Rückgabefähig",
            "Gib leere Zylinder zurück. Wir reinigen, prüfen und verwenden sie im nächsten Kreislauf.",
          ],
        ]
      : [
          [
            "Format",
            "108 mm · 38 g. Holds exactly 8 functional tablets. Built for pockets, bags, or desks.",
          ],
          ...
          [
            "Returnable",
            "Return empty cylinders to us. We clean, check and reuse them in the next cycle.",
          ],
        ],
    ...
    loopSteps: isDE
      ? [
          {
            t: "Empfangen",
            d: "Nachfüllzylinder kommt mit deiner Bestellung. Pfand inklusive.",
            img: "",
          },
      ...
      : [
          {
            t: "Receive",
            d: "Refill cylinder arrives with your order. Deposit included.",
            img: "",
          },
          { t: "Use", d: "One press. One tablet. Eight tablets per cylinder.", img: "" },
          {
            t: "Collect",
            d: "Slip empty cylinders into the return pouch as they're used.",
            img: "",
          },
          {
            t: "Return",
          ...
          {
            t: "Reuse",
            d: "If returned, we sterilize and refill it for someone else's ritual.",
            img: "",
          },
        ],
    ...
    ch08Desc: isDE
      ? "Der matte Aluminiumzylinder ist nicht nur Verpackung – er ist das Gefäß, in dem deine Nachfüllungen ankommen. Nutze ihn, leere ihn und entscheide: Schick ihn zurück für eine Pfand-Erstattung – oder behalte ihn für deinen Schreibtisch."
    ...
    faqDesc: isDE
      ? "Alles, was du wissen musst, bevor du mit dem Nachfüll-Ritual beginnst."
      : "Everything you need to know before starting the refill ritual.",
    faqItems: isDE
      ? [
          {
            q: "Wie funktioniert das Nachfüllsystem?",
            a: "Fülle deine VYTAL-Flasche mit kaltem Wasser, wirf eine Tablette hinein, warte ca. 90 Sekunden und trink. Für regelmäßige Nutzung: Nachfüllzylinder online bestellen – jeder Zylinder enthält 8 Tabletten und beinhaltet ein €4-Pfand.",
          },
          {
            q: "Was steckt in jeder Tablette?",
            a: "Vier Wirkstoffe: L-Theanin (200 mg), Ashwagandha KSM-66 (300 mg), natürliches Grüntee-Koffein (80 mg) und Magnesiumbisglycinat (150 mg). Kein Zucker, keine künstlichen Süßungsmittel.",
          },
          {
            q: "Ist das ein Nahrungsergänzungsmittel oder ein Energy Drink?",
            a: "VYTAL-Tabletten sind als Nahrungsergänzungsmittel eingestuft. Kein Ersatz für eine ausgewogene Ernährung. Enthält Koffein – nicht empfohlen für Kinder, Schwangere oder stillende Frauen.",
          },
          {
            q: "Warum Tabletten statt eines fertigen Drinks?",
            a: "Die meisten Fertiggetränke bestehen größtenteils aus Wasser. VYTAL schickt nur das funktionale Konzentrat. Du fügst lokales Wasser hinzu – bis zu 85 % weniger Versandvolumen.",
          },
          {
          ...
          },
          {
            ...
            a: "Kaltes Stilles Wasser löst die Tablette am besten auf. Sprudelwasser ergibt ein leichteres Ergebnis. Heißes Wasser vermeiden.",
          },
          {
            q: "Muss ich eine VYTAL-Flasche verwenden?",
            a: "Die Tabletten lösen sich in jedem sauberen Behälter auf. Die VYTAL-Flaschen sind für das Nachfüllsystem ausgelegt – aber du kannst die Tabletten auch mit einer anderen Flasche nutzen.",
          },
        ]
      : [
          {
          ...
          },
          {
            ...
            a: "Most ready-to-drink energy products are mostly water — you're shipping liquid across the country, packaged in a single-use can. VYTAL only ships the functional concentrate. You add local water. That reduces shipping volume by up to 85%.",
          },
          {
          ...
          },
          {
            ...
            a: "Cold still water dissolves the tablet most cleanly. Sparkling water works too and gives a slightly lighter, more refreshing result. Avoid hot water.",
          },
          {
            q: "Can I use any bottle, or does it have to be VYTAL?",
            a: "The tablets dissolve in any clean vessel with cold water. The VYTAL bottles are designed for the refill system — but you can use the tablets with any bottle you already own.",
          },
        ],
    // Final CTA
  ...
  head: () => ({
    meta: [
      { title: "Nachfüllen, nicht wegwerfen — VYTAL" },
      {
        name: "description",
        content:
          "Nachfüllbare Energie-Tablets statt Einwegdosen. Eine Flasche, pflanzliche Konzentrat-Tablets, ein Rückgabe-Loop — 85 % weniger Versandvolumen. So funktioniert VYTAL.",
      },
      { property: "og:title", content: "Nachfüllen, nicht wegwerfen — VYTAL" },
      {
        property: "og:description",
        content:
          "Ein nachhaltiges Nachfüll-Ritual für ruhigere Routinen und weniger Wegwerfgewohnheiten.",
      },
    ],
  }),
    ...
    <main className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <div className="relative z-10 h-full max-w-7xl mx-auto px-6 md:px-10 flex flex-col justify-between py-24">
          ...
          <div className="max-w-4xl">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              <a
                href="#ritual"
                className="inline-flex bg-background text-foreground px-7 py-3.5 rounded-full font-medium hover:bg-accent transition-all"
              >
                {r.heroCta1}
              </a>
              <Link
                to="/shop"
                hash="starter"
                className="inline-flex border border-background/40 text-background px-7 py-3.5 rounded-full font-medium hover:bg-background/10 transition-all"
              >
                {r.heroCta2}
              </Link>
            </div>
      ...
      <section className="relative bg-foreground text-background px-6 md:px-10 py-32 md:py-44 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto">
          <span className="font-mono text-[11px] tracking-[0.3em] uppercase text-background/60 reveal">
            {r.ch02Kicker}
          </span>
          <h2 className="reveal mt-6 font-display text-5xl md:text-7xl lg:text-8xl font-bold leading-[0.95] text-balance">
            {r.isDE ? (
              <>
                Energie sollte sich nicht
                <br />
                wegwerfbar
                <br />
                fühlen.
              ...
              <>
                ...
                shouldn&rsquo;t
                <br />
                feel <span className="italic font-light">disposable.</span>
              </>
            )}
          </h2>
          <div className="reveal mt-16 grid md:grid-cols-3 gap-6 max-w-4xl text-background/70">
            <p className="text-sm leading-relaxed">
              <span className="block font-mono text-[10px] uppercase tracking-[0.2em] text-background/40 mb-3">
                {r.ch02Single}
              </span>
              {r.ch02SingleText}
            </p>
      ...
      <section id="ritual" className="relative bg-background overflow-hidden">
        <div className="px-6 md:px-10 pt-32 md:pt-44 pb-12 max-w-7xl mx-auto">
          <span className="font-mono text-[11px] tracking-[0.3em] uppercase text-primary reveal">
            {r.ch03Kicker}
          </span>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 grid md:grid-cols-2 gap-12 items-center pb-24">
          <div
            ref={bubblesRef}
            className="relative aspect-[4/3] md:aspect-[3/4] rounded-3xl overflow-hidden bg-secondary will-change-transform"
          >
            <img
              src={refillTabletDrop}
              alt="Tablette fällt mit Blasen ins Wasser"
          ...
          <ol className="space-y-12">
            {r.ritualSteps.map((s) => (
              <li
                key={s.n}
                className="reveal grid grid-cols-[auto_1fr] gap-6 items-start border-t border-border pt-6"
              >
        ...
        <div className="relative h-[45svh] md:h-[38svh] min-h-[200px] w-full overflow-hidden">
          <img
            src={refillBubbles}
            alt="Blasen steigen durch ruhiges Wasser auf"
            className="absolute inset-0 w-full h-full object-cover scroll-rise"
            loading="lazy"
          />
      ...
      <section className="px-6 md:px-10 pt-12 md:pt-20 pb-6 md:pb-10 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-4 reveal lg:sticky lg:top-24">
            ...
            <span className="font-mono text-[11px] tracking-[0.3em] uppercase text-primary block">
              {r.ch04Kicker}
            </span>
            ...
            <p className="mt-6 text-muted-foreground leading-relaxed">{r.ch04Desc}</p>
            <a
              href="/contact"
            ...
            <div>
              <p className="font-display text-2xl md:text-3xl leading-snug">
                ...
                <span className="text-muted-foreground">
                  {r.isDE
                    ? "Hygienisch, luftdicht, und gebaut, um zu uns zurückzukommen – nicht in den Müll."
                    : "Hygienic, airtight, and built to come back to us — not the bin."}
                </span>
              </p>
        ...
        <div className="max-w-5xl mx-auto reveal">
          ...
          <div className="mt-12 grid grid-cols-4 gap-4 md:gap-10 max-w-sm md:max-w-lg mx-auto">
            {[
              ...
              {
                icon: (
                  <RotateCcw className="size-5 md:size-6 text-background/50" strokeWidth={1.5} />
                ),
                label: r.isDE ? "Rückgabe-Loop" : "Return loop",
              },
              {
                icon: (
                  <Droplets className="size-5 md:size-6 text-background/50" strokeWidth={1.5} />
                ),
        ...
        <ol className="lg:col-span-7 space-y-4">
              ...
              >
                <div className="flex items-start gap-6">
                  <div className="flex-shrink-0">
                    <span
                      className={`grid place-items-center size-8 md:size-12 rounded-full font-mono text-xs tracking-widest transition-all duration-700 ${on ? "bg-foreground text-background scale-110" : "bg-secondary text-muted-foreground"}`}
                    >
                      0{i + 1}
                    </span>
                  </div>
                  <div className="flex-1">
                    <h3 className="font-display text-lg md:text-3xl font-semibold tracking-tight">
                      {s.t}
                    </h3>
                    <p className="mt-1 md:mt-2 text-sm md:text-base text-muted-foreground leading-relaxed max-w-lg">
                      {s.d}
                    </p>
                  </div>
                  {i < 4 && (
                    <div className="hidden md:flex items-center pt-3">
                      <span
                        className={`block h-px transition-all duration-700 ${on ? "w-12 bg-foreground" : "w-6 bg-border"}`}
                      />
                    </div>
                  )}
                </div>
          ...
          <div className="mt-6 md:mt-10 grid grid-cols-3 gap-2 md:gap-3 text-xs text-muted-foreground">
            <div className="rounded-xl md:rounded-2xl border border-border p-2.5 md:p-4 bg-background/60">
              ...
              <p className="mt-1 md:mt-2 text-[10px] md:text-xs leading-snug">
                {r.loopDepositText}
              </p>
            </div>
            <div className="rounded-xl md:rounded-2xl border border-border p-2.5 md:p-4 bg-background/60">
  ...
  return (
    <section className="px-6 md:px-10 max-w-4xl mx-auto py-24 md:py-36">
      <div className="reveal mb-12">
        ...
        <p className="mt-4 text-muted-foreground max-w-md leading-relaxed">{r.faqDesc}</p>
      </div>
