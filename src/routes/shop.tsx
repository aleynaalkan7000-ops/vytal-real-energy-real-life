  ...
  head: () => ({
    meta: [
      { title: "Shop — VYTAL · Nachhaltige Energie-Tabletten. Kein Crash." },
      {
        name: "description",
        content:
          "Nachfüllbare pflanzliche Energie-Tablets als Alternative zu Energydrinks — ruhiger Fokus, kein Crash, kein Plastik. Starter Kit ab 40 €. Lieferung nach DE & AT.",
      },
      {
        property: "og:title",
        content: "Shop — VYTAL · Nachhaltige Energie-Tabletten. Kein Crash.",
      },
      {
        property: "og:description",
        content:
          "Sechs pflanzliche Energie-Geschmäcker. Ein wiederverwendbarer Zylinder. Die nachhaltige Alternative zu Energydrinks — ohne Crash, ohne Einwegdosen.",
      },
...
> = {
  focus: {
    ...
    sensory: "Stone-ground matcha character with fresh lime brightness and a clean herbal finish.",
    ...
    moment: "Made for library mornings, deep work blocks and long study sessions.",
  },
  ...
  flow: {
    ...
    moment: "Made for commuting, classes, slow mornings and everyday routines.",
  },
  ...
  refresh: {
    ...
    moment: "Made for screen fatigue, hot afternoons and mentally overloaded days.",
  },

  boost: {
    audience: "Pressure mode",

    sensory: "Sharp citrus opening followed by warm ginger heat and a dry sparkling finish.",

    quality:
      "A more refined interpretation of high-energy drinks — bold and energising without the heavy syrup-like sweetness.",

    moment: "Made for deadlines, early mornings and overloaded schedules.",
  },

  balance: {
    audience: "Slower clarity",

    sensory: "Juicy pear layered with soft sage and subtle botanical depth.",

    quality:
      "Inspired by premium herbal infusions and minimalist wellness drinks with a softer, calmer flavor direction.",

    moment: "Made for planning, reading, creative work and low-pressure productivity.",
  },

  recharge: {
    audience: "Late hours",

    sensory: "Dark cherry richness balanced with elegant black tea bitterness and low sweetness.",

    quality:
      "A deeper and more mature flavor profile for people who dislike artificial late-night energy drinks.",

    moment: "Made for evening work, studio sessions and finishing things peacefully.",
  },
};
...
function useShopTx() {
  ...
  return {
    ...
    unityDesc: isDE
      ? "Transparente Collector-Edition, inspiriert von Licht, Ritual und Wiederverwendung."
    ...
    starterBadge2: isDE
      ? "Alle 6 Geschmäcker · Wähle deine Flaschenfarbe · Zylinder inklusive · Pfand inklusive"
    ...
    loopSteps: isDE
      ? [
          ...
          {
            t: "Zurückschicken",
            d: "Beutel portofrei in jeden Briefkasten einwerfen. Vorfrankiert. Keine App. Oder einfach behalten und weiterverwenden – du entscheidest.",
          },
          {
            t: "Wiederverwenden",
            d: "Bei Rückgabe sterilisieren wir ihn und befüllen ihn für ein anderes Ritual.",
          },
        ]
      : [
          ...
          {
            t: "Return",
            d: "Drop the pouch unfranked in any postbox. Pre-paid. No app. Or simply keep it to repurpose at home. You decide when the loop closes.",
          },
          { t: "Reuse", d: "If returned, we sterilize and refill it for someone else's ritual." },
        ],
    loopDeposit: isDE ? "Pfand" : "Deposit",
    loopDepositText: isDE
      ? "€4 pro Zylinder. Vollständig erstattet bei Rückgabe. Keine Mindestmenge, keine Eile."
      : "€4 per cylinder. Fully refunded upon return. No minimums, no rush.",
    loopHygiene: isDE ? "Hygiene" : "Hygiene",
    loopHygieneText: isDE
    ...
    loopRealityText: isDE
      ? "Deutlich bewusster als Dosen-Drinks. Erster öffentlicher Nachhaltigkeitsbericht geplant für Q4 2025."
      : "Significantly more conscious than canned drinks. First public sustainability report planned for Q4 2025.",
    ...
    costItems: isDE
      ? [
          ...
          {
            val: "+ €4",
            desc: "Zylinder-Pfand pro Bestellung – erstattet bei Rückgabe von 5 Leerteilen",
          },
        ]
      : [
    ...
    cylinderSpecs: isDE
      ? [
          [
            "Immer dabei",
            "Wird automatisch mit jeder Nachfüllung mitgeliefert. Kein Sonderkauf nötig.",
          ],
          [
            "8 Tabletten",
            "Fasst einen vollständigen Geschmackszyklus – alles luftdicht und frisch.",
          ],
          [
            "Leiser Fußabdruck",
            "Keine Umverpackungen, kein Plastik. Nur die Nachfüllung im Zylinder.",
          ],
          [
            "Pfand erstattet",
            "Portofrei zurückschicken – oder als Deko auf dem Schreibtisch behalten.",
          ],
        ]
      : [
          [
          ...
          [
            "Holds 8 refills",
            "Holds a complete flavor cycle, keeping everything airtight and fresh",
          ],
          [
            "A Quiet Footprint",
    ...
    accessoriesDesc: isDE
      ? "Optionale Erweiterungen des Systems. Alle Nachfüllungen passen."
    ...
    faqItems: isDE
      ? [
          {
            q: "Was genau ist das VYTAL-System?",
            a: "VYTAL ist eine nachfüllbasierte Alternative zu Einweg-Energy-Drinks. Du kaufst einmal eine wiederverwendbare Flasche, dann löst du eine pflanzenbasierte Konzentrat-Tablette in kaltem Wasser auf. Die Nachfüllzylinder kommen zu uns zurück, werden sterilisiert und erneut ausgegeben.",
          },
          {
            q: "Was steckt in den Tabletten?",
            a: "Vier Wirkstoffe: L-Theanin (200 mg), Ashwagandha KSM-66 (300 mg), natürliches Grüntee-Koffein (80 mg) und Magnesiumbisglycinat (150 mg). Kein Zucker, keine künstlichen Süßungsmittel, kein synthetisches Koffein.",
          },
          {
            q: "Wie viele Tabletten sind in einem Zylinder?",
            a: "Jeder matte Aluminiumzylinder enthält genau 8 Tabletten – eine pro Drink. Das sind acht ruhige Nachfüllmomente, bevor der Zylinder leer und bereit zur Rückgabe ist.",
          },
          {
            q: "Wie funktioniert der Pfand- und Rückgabe-Loop?",
            a: "Jeder Nachfüllzylinder beinhaltet ein €4-Pfand. Sammle fünf leere Zylinder, wirf sie portofrei mit dem vorfrankierten Rückgabebeutel in jeden Briefkasten. Wir sterilisieren sie und bringen sie zurück in den Kreislauf. Dein Pfand wird mit der nächsten Bestellung verrechnet.",
          },
          {
            q: "Was ist, wenn ich die Zylinder nicht zurückgebe?",
            a: "Keine Pflicht, keine Strafe. Die Zylinder aus Aerospace-Aluminium sind schön genug fürs Regal. Du erhältst einfach das Pfand nicht zurück.",
          },
          {
            q: "Ist VYTAL für den täglichen Gebrauch geeignet?",
            a: "Ja – das Produkt ist für den täglichen Einsatz konzipiert. Die Formel enthält 80 mg natürliches Koffein (ungefähr eine Tasse Kaffee), kombiniert mit L-Theanin für eine gleichmäßige Kurve. Nicht empfohlen für Kinder, Schwangere oder stillende Frauen.",
          },
          {
            q: "Welches Wasser soll ich verwenden?",
            a: "Kaltes Stilles Wasser löst die Tablette am saubersten auf. Sprudelwasser ergibt ein leichteres, erfrischenderes Ergebnis. Heißes Wasser vermeiden – es kann Wirkstoffe beeinflussen.",
          },
          {
            q: "Wie lange dauert die Lieferung?",
            a: "Derzeit versenden wir nach Deutschland und Österreich. Standardlieferung: 2–4 Werktage. Alle Verpackungen sind plastikfrei aus Recycling-Karton.",
          },
        ]
      : [
          {
    ...
    qvDepositNote: isDE
      ? "Pfand inklusive. Rückgabe-Loop gilt für Nachfüllzylinder."
    ...
    qvAddToCart: isDE
      ? (price: string) => `In den Warenkorb · ${price}`
      : (price: string) => `Add to cart · ${price}`,
    qvAdded: isDE ? "Hinzugefügt ✓" : "Added ✓",
    qvDepositBreakdown: isDE
      ? (base: string, dep: string) =>
          `${base} Nachfüllung + ${dep} erstattungsfähiges Zylinder-Pfand.`
      : (base: string, dep: string) => `${base} refill + ${dep} refundable cylinder deposit.`,
    // Starter kit quick view
    skKicker: isDE
      ? "Starter Kit · Vollständiges Nachfüll-Ritual"
      : "Starter Kit · Complete refill ritual",
    skH2: isDE ? "VYTAL Starter Kit" : "VYTAL Starter Kit",
    skDesc: isDE
      ? "Der vollständige Einstieg ins VYTAL-Nachfüllsystem: eine wiederverwendbare Flasche, ein Nachfüllzylinder, alle sechs Geschmäcker, Hülle, Beutel und Onboarding-Ritual-Karte."
      : "The complete entry into the VYTAL refill system: one reusable bottle, one refill cylinder, all six functional flavors, sleeve, pouch and onboarding ritual card.",
    skItems: isDE
      ? [
    ...
    productDescDe: {
      focus:
        "FOCUS wurde für lange Tage, volle To-do-Listen und intensive Lernsessions entwickelt. Eine Kombination aus natürlichen Energiequellen und einer ruhigeren Formulierung unterstützt Konzentration und Produktivität – ohne den extremen Charakter klassischer Energy Drinks.",
      ...
      refresh:
        "REFRESH wurde für Momente entwickelt, in denen neue Energie und mentale Frische gebraucht werden. Ideal unterwegs, zwischen Terminen oder nach langen Stunden vor dem Bildschirm.",
      boost:
        "BOOST wurde für stressige Tage, hohe mentale Belastung und Momente mit wenig Schlaf entwickelt. Die stärkere Formulierung liefert intensive, aber bewusst funktionale Energie – ohne künstlich zu wirken.",
      balance:
        "BALANCE kombiniert leichte Energie mit einem ruhigeren Konsumgefühl – entwickelt für Menschen, die bewusster konsumieren möchten.",
      recharge:
        "RECHARGE wurde für späte Lern- oder Arbeitsphasen entwickelt, in denen Fokus gebraucht wird, ohne den Körper unnötig zu überlasten. Die Formulierung fühlt sich ruhiger an als klassische Energy Drinks.",
      "go-bottle":
        "Mit 750 ml Fassungsvermögen, speziell für das VYTAL-Nachfüllsystem entwickelt. Die standardisierte Form ermöglicht dem Dispenser, Größe, Füllstand, Mischverhältnis und gewünschte Intensität automatisch zu erkennen.",
      "flow-bottle":
        "Entwickelt für längere Sessions und direkte Arbeit mit dem Nachfüllsystem. Der Dispenser erkennt automatisch Füllstand, Behältergröße und die ideale Intensität für größere Volumina.",
      "office-bottle":
        "Mit 750 ml Fassungsvermögen kombiniert diese Flasche Funktionalität mit hochwertiger Ästhetik – speziell für moderne Arbeitsumgebungen entwickelt. Soft-Close-Deckel, fingerabdruckfreie Oberfläche und auslaufsichere Konstruktion.",
      "home-container":
        "Entwickelt für größere Nachfüllmengen. Standardisierte Größen ermöglichen präzises Befüllen, automatische Dosierungsanpassung und hygienische Heimnutzung.",
      "unity-bottle":
        "Diese limitierte Edition mit 750 ml ist nicht nur funktional — sie ist Teil der Marken- und Community-Erfahrung. Limitierte Drops und exklusive Designs schaffen emotionalen Wert und Sammlerwert.",
      "starter-kit":
        "Der einfachste Einstieg in VYTAL. Eine GO BOTTLE und je eine Nachfüllung jedes Geschmacks — finde deinen Tag, deinen Abend, dein Wochenende.",
    } as Record<string, string>,
    productFlavorNoteDe: {
    ...
    bottleDetailsDe: {
      ...
      "flow-bottle": {
        intro:
          "Minimale Hydrations-Flasche für ruhigere Alltagsroutinen und langsame Nachfüllrituale.",
        bullets: [
      ...
      "office-bottle": {
        intro:
          "Gebürstete Edelstahlflasche für Schreibtischarbeit, Pendeln und längere Bürosessions.",
        bullets: [
      ...
      "home-container": {
        intro:
          "Heimlagerungsgefäß für sichtbare, organisierte und einfach zu teilende Nachfüllroutinen.",
        bullets: [
      ...
      "unity-bottle": {
        intro:
          "Limitierte visuelle Edition mit transluzentem Sammler-Charakter als saisonale Erweiterung des Nachfüllrituals.",
        bullets: [
      ...
      >
        ...
        <div className="grid md:grid-cols-2">
          ...
          <div className="p-6 md:p-10">
            ...
            <h2 className="mt-4 font-display text-4xl font-extrabold leading-[0.95]">{s.skH2}</h2>

            <p className="mt-5 text-muted-foreground leading-relaxed">{s.skDesc}</p>
            ...
            <p className="mt-3 text-[11px] text-muted-foreground">{s.skDepositNote}</p>
          </div>
        </div>
      </div>
    </div>
...
const shopFaqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "What exactly is the VYTAL system?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "VYTAL is a refill-based alternative to disposable energy drinks. You buy a reusable bottle once, then dissolve a plant-based concentrate tablet in cold water. The refill cylinders come back to us, get sterilized, and go out again — a quiet loop designed to waste less from the start.",
      },
    },
    {
      "@type": "Question",
      name: "What's inside the tablets?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Four active ingredients: L-Theanine (200 mg), Ashwagandha KSM-66 (300 mg), natural Green Tea Caffeine (80 mg), and Magnesium Bisglycinate (150 mg). No sugar, no artificial sweeteners, no synthetic caffeine.",
      },
    },
    {
      "@type": "Question",
      name: "How does the deposit and return loop work?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Every refill cylinder includes a €4 refundable deposit. Collect five empty cylinders, drop them unfranked in any postbox using the included pre-paid return pouch. We sterilize them and put them back into the loop. Your deposit is credited to your next order.",
      },
    },
    {
      "@type": "Question",
      name: "Is VYTAL suitable for daily use?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes — it's designed for everyday use. The formulation contains 80 mg of natural caffeine, paired with L-Theanine to smooth the curve. Not recommended for children, pregnant or breastfeeding women, or people sensitive to caffeine.",
      },
    },
  ],
};
...
const shopSchema = {
  ...
  name: "VYTAL Shop",
  description:
    "Refillable plant-based focus supplements — starter kit, six functional flavors and the circular refill loop.",
  numberOfItems: 7,
  itemListElement: [
    {
      "@type": "ListItem",
    ...
    },
    {
      "@type": "ListItem",
      position: 2,
      name: "VYTAL Focus — Matcha Lime",
      url: "https://vytal-energy.de/shop/focus",
    },
    {
      "@type": "ListItem",
      position: 3,
      name: "VYTAL Flow — Peach Green Tea",
      url: "https://vytal-energy.de/shop/flow",
    },
    {
      "@type": "ListItem",
      position: 4,
      name: "VYTAL Refresh — Berry Mint",
      url: "https://vytal-energy.de/shop/refresh",
    },
    {
      "@type": "ListItem",
      position: 5,
      name: "VYTAL Boost — Citrus Ginger",
      url: "https://vytal-energy.de/shop/boost",
    },
    {
      "@type": "ListItem",
      position: 6,
      name: "VYTAL Balance — Pear Sage",
      url: "https://vytal-energy.de/shop/balance",
    },
    {
      "@type": "ListItem",
      position: 7,
      name: "VYTAL Recharge — Cherry Black Tea",
      url: "https://vytal-energy.de/shop/recharge",
    },
  ],
};
...
function ShopPage() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground overflow-x-hidden">
          ...
          <div className="relative z-10 flex flex-row items-center justify-between gap-3">
            <div className="flex items-center gap-2 md:gap-5 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="hidden md:block mt-1 text-base text-black/60">{s.unityDesc}</p>
              </div>
            </div>
      ...
      <section
        id="starter-kit"
        className="relative min-h-[55svh] md:min-h-[100svh] flex items-end overflow-hidden bg-gradient-to-b from-secondary/70 via-background to-background"
      >
        ...
        <div className="relative max-w-7xl mx-auto w-full px-6 md:px-10 pb-10 md:pb-32 pt-16 md:pt-40 grid md:grid-cols-12 gap-10">
          <div className="md:col-span-7">
            ...
            <h1 className="font-display text-[clamp(3rem,8.5vw,8rem)] font-extrabold leading-[0.92] tracking-tighter text-balance reveal">
              {s.isDE ? "Starte dein" : "Start your"}{" "}
              <em className="not-italic italic font-light text-primary">{s.heroH1b}</em>
            </h1>
      ...
      <section className="px-6 md:px-10 max-w-5xl mx-auto py-10 md:py-20 text-center">
        ...
        <p className="mt-8 max-w-xl mx-auto text-muted-foreground reveal">{s.quietDesc}</p>
      </section>
      ...
      <section id="refills" className="px-6 md:px-10 max-w-7xl mx-auto pt-10 md:pt-20 pb-20">
        <div className="max-w-3xl mb-14 reveal">
          ...
          <h2 className="mt-5 font-display text-4xl md:text-6xl font-extrabold leading-[0.98] tracking-tight">
            {s.refillsH2a}
            <br />
            <span className="italic font-light text-muted-foreground">{s.refillsH2b}</span>
          </h2>

          <p className="mt-6 text-muted-foreground leading-relaxed max-w-xl">{s.refillsDesc}</p>
        </div>

        <div className="grid grid-cols-2 lg:grid-cols-3 gap-x-3 gap-y-8 md:gap-x-6 md:gap-y-14">
          {refills.map((p, i) => (
            <RefillCard key={p.slug} p={p} i={i} onOpen={() => setSelectedProduct(p)} />
          ))}
        </div>
      </section>
      ...
      <section id="accessories" className="px-6 md:px-10 max-w-7xl mx-auto pb-24 md:pb-32">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-x-3 gap-y-6 md:gap-x-6 md:gap-y-12 items-start">
          {bottles.map((b) => (
            <button
              id={b.slug === "unity-bottle" ? "unity" : undefined}
              key={b.slug}
            ...
            >
              <div className="aspect-[4/5] relative overflow-hidden rounded-md bg-secondary/40">
                <img
                  ...
                  alt={b.name}
                  loading="lazy"
                  className="absolute inset-0 w-full h-full object-cover transition-transform duration-[1200ms] ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:scale-[1.04]"
                />
              ...
              <p className="text-xs md:text-sm text-muted-foreground mt-1.5 leading-relaxed">
                {s.isDE ? (s.bottleTaglineDe[b.slug] ?? b.tagline) : b.tagline}
              </p>
            </button>
          ))}
        </div>
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center px-6 md:px-10 overflow-hidden bg-secondary/40">
        <div className="absolute inset-0 -z-10">
          ...
          <div
            className="absolute -bottom-40 -right-20 w-[520px] h-[520px] rounded-full bg-accent/25 blur-3xl animate-drift"
      ...
      {starterKitOpen && <StarterKitQuickView onClose={() => setStarterKitOpen(false)} />}
      <DiscountBanner />
      <SiteFooter />
    </main>
  );
    ...
    <section className="bg-foreground text-background py-24 md:py-32 px-6 md:px-10">
      <div className="max-w-7xl mx-auto">
        <div className="reveal flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          <p className="text-background/55 text-sm max-w-xs leading-relaxed">{s.reviewsDesc}</p>
        </div>
    ...
    >
      <div className="aspect-[4/5] relative overflow-hidden rounded-md bg-secondary/40">
        ...
        <div
          ...
          style={{
            background: `linear-gradient(180deg, transparent 40%, ${id?.hex ?? "#A8C49D"} 130%)`,
          }}
        />
        <span className="absolute top-4 left-4 inline-flex items-center gap-2 font-mono text-[9px] uppercase tracking-[0.25em] bg-background/85 backdrop-blur px-2.5 py-1.5 rounded-full">
          <span
            ...
            style={{ background: id?.hex ?? "var(--primary)" }}
          />
          {s.inRefillLoop}
        </span>
      ...
      <div className="mt-3 md:mt-5 flex items-baseline justify-between gap-2">
        <div>
          ...
          <p className="font-display text-base md:text-xl font-semibold tracking-tight mt-0.5">
            {p.name.replace("VYTAL ", "")}
          </p>
        </div>
        <span className="font-mono text-[10px] md:text-xs text-muted-foreground shrink-0">
          {formatPrice(parsePrice(p.price) + 4)}
        </span>
      </div>
      <p className="text-[11px] md:text-[13px] font-mono text-primary/80 mt-1">
        {id?.mood ?? p.flavor}
      </p>
...
function ProductQuickView({ product, onClose }: { product: Product; onClose: () => void }) {
  ...
  const currentColorName = activeVariant
        ...
        <div className="grid md:grid-cols-2">
          ...
          <div className="p-8 md:p-10">
            ...
            <p className="mt-5 text-muted-foreground leading-relaxed">
              {s.isDE
                ? (s.productDescDe[product.slug] ?? product.description)
                : product.description}
            </p>
            ...
            {product.flavor && (
              <div className="mt-6 rounded-2xl border border-border p-5 bg-secondary/30">
                ...
                <p className="text-sm text-muted-foreground">
                  {s.isDE
                    ? (s.productFlavorNoteDe[product.slug] ?? product.flavorNote)
                    : product.flavorNote}
                </p>
              </div>
            )}
              ...
              (() => {
                ...
                const bottleTexts: Record<string, { intro: string; bullets: string[] }> = {
                  "office-bottle": {
                    ...
                    bullets: [
                      "Stainless steel exterior with professional office look.",
                      "Designed for daily hydration and VYTAL refill rituals.",
                      "Suitable for cold still water and VYTAL tablets.",
                      "Hand-wash recommended to protect lid and finish.",
                      "Do not use if dented, leaking or visibly damaged.",
                    ],
                  },
                  "go-bottle": {
                    intro:
                    ...
                    bullets: [
                      "Soft everyday carry feel.",
                      "Designed for cold still water and VYTAL tablets.",
                      "Easy to carry in bags and daily setups.",
                      "Hand-wash recommended.",
                      "Do not use if cracked, leaking or visibly damaged.",
                    ],
                  },
                  "flow-bottle": {
                    intro:
                    ...
                    bullets: [
                      "Clean minimal design for everyday hydration.",
                      "Suitable for cold still water and VYTAL tablets.",
                      "Designed for repeated daily use.",
                      "Hand-wash recommended to protect the finish.",
                  ...
                  "home-container": {
                    ...
                    bullets: [
                      "Intended for home storage and shared routines.",
                      "Store in a dry, cool place away from direct sunlight.",
                      "Keep closed when not in use.",
                      "Clean before first use.",
                      "Do not use if cracked or visibly damaged.",
                    ],
                  },
                  "unity-bottle": {
                    intro:
                    ...
                    bullets: [
                      "Limited-edition visual finish.",
                      "Designed for cold still water and VYTAL tablets.",
                      "Refills are sold separately unless included in a bundle.",
                      "Hand-wash recommended to protect the surface finish.",
                      "Do not use if cracked, leaking or visibly damaged.",
                    ],
                  },
                };
