    ...
    <footer className="px-6 pt-20 pb-10 border-t border-border bg-secondary/40">
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-10 mb-16">
        <div className="md:col-span-2 max-w-sm">
          <Link
            to="/"
            className="inline-flex items-center gap-3 font-display text-2xl font-extrabold tracking-tight uppercase"
          >
            Vytal
            <img src={logoTransparent} alt="" aria-hidden className="h-6 opacity-50" />
          </Link>
          <p className="mt-4 text-sm text-muted-foreground leading-relaxed">{tx.footer.desc}</p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/refill" className="hover:text-primary">
                {tx.nav.refill}
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/imprint" className="hover:text-primary font-semibold text-foreground">
                {tx.footer.imprintLabel}
              </Link>
            </li>
          </ul>
        </div>
        <div>
          ...
          <p className="text-sm text-muted-foreground mb-3">{tx.footer.newsletterDesc}</p>
          {sent ? (
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] uppercase tracking-widest text-muted-foreground border-t border-border pt-8">
        ...
        <img src={logoTransparent} alt="VYTAL" className="h-7 opacity-40" />
        <div className="flex gap-6">
          ...
          <Link to="/imprint" className="hover:text-foreground font-semibold text-foreground">
            {tx.footer.imprintLabel}
          </Link>
        </div>
      </div>
